...
Label(f0, text="Times Of India", font="lucida 33 bold").pack()
Label(f0, text="July 22, 2020", font="lucida 13 bold").pack()

f0.pack()


f1=Frame(root, width=900, height=200, padx=50)
...
f3=Frame(root, width=900, height=200, padx=50)
